        ...
        <div className="mt-auto pt-3 space-y-2">
          ...
          <div className="flex gap-2">
            <a
              ...
              className="flex-1 inline-flex items-center justify-center rounded-md border-2 border-gray-300 bg-white px-3 py-2 text-xs font-medium text-gray-700 hover:bg-gray-50 hover:border-[#25D366] hover:text-[#25D366] transition-all"
            >
