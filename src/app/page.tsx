      ...
      <main className="flex-1 w-full max-w-[1440px] mx-auto px-4 md:px-10 py-8">
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Product Card 1 */}
            <Link href="/category/ppe/head-protection/proguard-safety-helmet-type-1" className="group bg-[#111] rounded-xl border border-gray-800 hover:border-primary/50 transition-all duration-300 overflow-hidden flex flex-col h-full">
              <div className="relative aspect-[4/5] overflow-hidden bg-white/5">
                <div className="absolute top-3 left-3 bg-red-600 text-white text-xs font-bold px-2 py-1 rounded z-10">-20%</div>
                <div className="absolute inset-0 bg-center bg-cover transition-transform duration-500 group-hover:scale-110" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuD5IwWxFoxD6L9iSDgu7ITA5WSI1mGMzammoYXBZA-3lVBO8E8VyL_L0pcOD8bsG3TyYCrEfB0mNsKOniFxqlSEQ1kWdW_PVIyVdEusGDLr0qqxkPYDjMRxT3b8WlKKlslDwpGhYF-X1pmBjkFPgn7Yu0qyKM1I4X4ubRuLjuML6p78yCchsTJ-osKSZdxJ7U5R71DIaRzmC099tzMwin2wGhiCZh5ZWpsP-0V-b_87kJVdpVkylAhAiRwlxRAm5ZshdipD79wG2P4T')" }}></div>
                <button className="absolute bottom-4 right-4 bg-primary text-black p-2 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 z-10">
                  <span className="material-symbols-outlined">add_shopping_cart</span>
                </button>
              </div>
              <div className="p-5 flex flex-col flex-1">
                <p className="text-xs text-gray-500 mb-1">Head Protection</p>
                ...
                <div className="mt-auto flex items-end gap-2">
                  ...
                  <span className="text-gray-500 text-sm line-through decoration-red-500">$31.99</span>
                </div>
              </div>
            </Link>
            {/* Product Card 2 */}
            <Link href="/category/ppe/head-protection/proguard-safety-helmet-type-1" className="group bg-[#111] rounded-xl border border-gray-800 hover:border-primary/50 transition-all duration-300 overflow-hidden flex flex-col h-full">
              <div className="relative aspect-[4/5] overflow-hidden bg-white/5">
                <div className="absolute inset-0 bg-center bg-cover transition-transform duration-500 group-hover:scale-110" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCCgWooSAhgjkzHAD3nglqfZaGlQL6fF2YrOxaVYWnXQxsvaOdLlS_W3c2shMJHQ55TBgaBY36FNdt2yLT0n0alBdudqgPEgnGJlyBwcU3KTNMHUp3mwlhf1DfX1rG-XNVBZGa8NlNUJfDf3tZNet1o0DGRXaYd6vRDw3WKbqixlsZReW8Ax8r5EypOHlCzyrpQEJmY43d7Qk1whebmRjeVhRVp9SbyB6bHuthSikTfevgBtYCdg1Rmmo8j9qvdUljD9hYJMppEuWh7')" }}></div>
                <button className="absolute bottom-4 right-4 bg-primary text-black p-2 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 z-10">
                  <span className="material-symbols-outlined">add_shopping_cart</span>
                </button>
              </div>
              <div className="p-5 flex flex-col flex-1">
                <p className="text-xs text-gray-500 mb-1">Eye Protection</p>
            ...
            <Link href="/category/ppe/head-protection/proguard-safety-helmet-type-1" className="group bg-[#111] rounded-xl border border-gray-800 hover:border-primary/50 transition-all duration-300 overflow-hidden flex flex-col h-full">
              <div className="relative aspect-[4/5] overflow-hidden bg-white/5">
                <div className="absolute top-3 left-3 bg-primary text-black text-xs font-bold px-2 py-1 rounded z-10">Best Seller</div>
                <div className="absolute inset-0 bg-center bg-cover transition-transform duration-500 group-hover:scale-110" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuB5np85BL7NbPpsI80Ye4EizDunz0--nuS_q2EUgcKnU8Di-uvBdB_pYDq57a5BLY63jkVLKeXBkT0xVmvQzC9W1PogjKANsF_cRgsSms0UzvG5KM7I0zOKujCJX9qTRBpfDEnygb1P5RK0tGyeyDV0IuCbcJcf3ClOVGhkMeFaLiNzQriT5gTdTLc22rLxXs0Vj3yDPqvT-BE9rngJ1bF4xvX9teYhsQl_ZoUU6YiJP1LkGhPaMtjmvC_kUhOAPH-mvoIxukexiVHL')" }}></div>
                <button className="absolute bottom-4 right-4 bg-primary text-black p-2 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 z-10">
                  <span className="material-symbols-outlined">add_shopping_cart</span>
                </button>
              </div>
              <div className="p-5 flex flex-col flex-1">
                <p className="text-xs text-gray-500 mb-1">Apparel</p>
            ...
            <Link href="/category/ppe/head-protection/proguard-safety-helmet-type-1" className="group bg-[#111] rounded-xl border border-gray-800 hover:border-primary/50 transition-all duration-300 overflow-hidden flex flex-col h-full">
              <div className="relative aspect-[4/5] overflow-hidden bg-white/5">
                <div className="absolute inset-0 bg-center bg-cover transition-transform duration-500 group-hover:scale-110" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDzZR1HomkeoIUQ6SDVWnZz5qkOt_YoNLBQh2qeNNWm3rp6tSYWruFFZSLizS9w_d4iWrNB5O8UyfG0s6K9YwsQMNfEwN3xBiMBLrGFTZ8yJ1_-aUW3yxtnEwDaRG-wU_pZc20bUFK0Xwfexktc14HM2YZIa7RfHNWEkAKDjWxItvTh1dmd_xD_vU3wgbvWu7_LVD072ZXqH3KwW6UpYXdq3IM9hob8O59zyt4T85rnrHxu4U5RAIhkuwwrU3a3KNzRQi--xs_k7UrY')" }}></div>
                <button className="absolute bottom-4 right-4 bg-primary text-black p-2 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 z-10">
                  <span className="material-symbols-outlined">add_shopping_cart</span>
                </button>
              </div>
              <div className="p-5 flex flex-col flex-1">
                ...
                <div className="mt-auto flex items-end gap-2">
                  ...
                  <span className="text-gray-500 text-sm line-through decoration-red-500">$110.00</span>
                </div>
              </div>
            </Link>
          </div>
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Industry Card 1 */}
            <Link className="group relative overflow-hidden rounded-xl aspect-video bg-[#111] border border-gray-800 hover:border-primary transition-colors" href="/industries">
              <div className="absolute inset-0 bg-cover bg-center opacity-40 group-hover:opacity-20 transition-opacity" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuB1z6vZHHKot_Pwwg8Ui2jIoOZN1ho1fO14wGH-pNucY9WdK18abNkrjfJDsCOdk_7Gtun0WJH4FdnvCFArsjBPudUcKqvZmA4L1LnBPlk_h-yjKOBf6oES8kx7ic3C7iPvCQIlHLpbcX-OiND63LYETJIhuDRRknJU2o1hGc9mji0BlvJhopf3W7sd9gPScZGyS8o8gGbJAOgxdQomlTMdFtijzIXdJikZyr4QfkVPpFh1-yVefbLSL63N1BjKjjSh7Xp-R7nXH0kf')" }}></div>
              <div className="relative z-10 flex flex-col items-center justify-center h-full p-6 text-center">
                <div className="w-16 h-16 rounded-full bg-black/80 border border-gray-800 flex items-center justify-center mb-4 group-hover:scale-110 group-hover:border-primary transition-all">
                ...
                <p className="text-sm text-gray-400 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">Site safety, fall protection &amp; heavy machinery gear.</p>
              </div>
            </Link>
            {/* Industry Card 2 */}
            <Link className="group relative overflow-hidden rounded-xl aspect-video bg-[#111] border border-gray-800 hover:border-primary transition-colors" href="/industries">
              <div className="absolute inset-0 bg-cover bg-center opacity-40 group-hover:opacity-20 transition-opacity" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDpb_Aj3ch3m6a2Vw5068g6KNVejp_x_1XdkxMKifhL3detY6fbpgq0BL7MRIOU9HykkYhOUnS7JuQDYX0AGoLG2V9hERIpX3zskguL-fsqe4evqVrWw6VHf1GYr29Vly61S3wvXbm5fcHSjrlAx3RyuJBlt8YSX59jgQWqPGcxtCnr39NSnLacv_IlkgZF91f2M_I6gKFKSRQbJ2kp5eARtVwxBDQc0hLRDE4zIQnLy_w_BjUebwTAMsBTWTtUmkKZhrYdOJuhAYZ6')" }}></div>
              <div className="relative z-10 flex flex-col items-center justify-center h-full p-6 text-center">
                <div className="w-16 h-16 rounded-full bg-black/80 border border-gray-800 flex items-center justify-center mb-4 group-hover:scale-110 group-hover:border-primary transition-all">
                ...
                <p className="text-sm text-gray-400 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">Assembly line PPE, hearing &amp; respiratory protection.</p>
              </div>
            </Link>
            {/* Industry Card 3 */}
            <Link className="group relative overflow-hidden rounded-xl aspect-video bg-[#111] border border-gray-800 hover:border-primary transition-colors" href="/industries">
              <div className="absolute inset-0 bg-cover bg-center opacity-40 group-hover:opacity-20 transition-opacity" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAyPE-Y3ndkJ4T3S9YJWEsP57TnjOfbm4jltmehMKLfhmipBTsTfwjttyx3ZNw7dukOTWByODsZORVIEkliqw75X6gVJR7RLBkR4djOFyGPtnFzqkG00gVG-25-gp4Fx3u4AO6TCBoxASXuvCoPI-rNlE4w1O4L4bFoSMD7ck_Q7PKCYhJe7tsF3ovn9jxaYk7pLDnof6GXwbIGrd1sMBPDYrbbGRi7YzVCVx3F_6lXHUGAkDReX1ukmBXGuWdY-EbfKKQJsffv03PM')" }}></div>
              <div className="relative z-10 flex flex-col items-center justify-center h-full p-6 text-center">
                <div className="w-16 h-16 rounded-full bg-black/80 border border-gray-800 flex items-center justify-center mb-4 group-hover:scale-110 group-hover:border-primary transition-all">
                ...
                <p className="text-sm text-gray-400 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">Explosion proof gear, lights &amp; high-vis apparel.</p>
              </div>
            </Link>
          </div>
        </section>
