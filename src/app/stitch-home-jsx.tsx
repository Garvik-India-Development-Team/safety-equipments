    ...
    <main className="flex-1 w-full max-w-[1440px] mx-auto px-4 md:px-10 py-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="group bg-surface-dark rounded-xl border border-border-dark hover:border-primary/50 transition-all duration-300 overflow-hidden flex flex-col h-full">
                    <div className="relative aspect-[4/5] overflow-hidden bg-white/5">
                        ...
                        <div className="w-full h-full bg-center bg-cover transition-transform duration-500 group-hover:scale-110" data-alt="Yellow hard hat safety helmet" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuD5IwWxFoxD6L9iSDgu7ITA5WSI1mGMzammoYXBZA-3lVBO8E8VyL_L0pcOD8bsG3TyYCrEfB0mNsKOniFxqlSEQ1kWdW_PVIyVdEusGDLr0qqxkPYDjMRxT3b8WlKKlslDwpGhYF-X1pmBjkFPgn7Yu0qyKM1I4X4ubRuLjuML6p78yCchsTJ-osKSZdxJ7U5R71DIaRzmC099tzMwin2wGhiCZh5ZWpsP-0V-b_87kJVdpVkylAhAiRwlxRAm5ZshdipD79wG2P4T')" }}></div>
                ...
                <div className="group bg-surface-dark rounded-xl border border-border-dark hover:border-primary/50 transition-all duration-300 overflow-hidden flex flex-col h-full">
                    <div className="relative aspect-[4/5] overflow-hidden bg-white/5">
                        <div className="w-full h-full bg-center bg-cover transition-transform duration-500 group-hover:scale-110" data-alt="Safety protective glasses on table" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuCCgWooSAhgjkzHAD3nglqfZaGlQL6fF2YrOxaVYWnXQxsvaOdLlS_W3c2shMJHQ55TBgaBY36FNdt2yLT0n0alBdudqgPEgnGJlyBwcU3KTNMHUp3mwlhf1DfX1rG-XNVBZGa8NlNUJfDf3tZNet1o0DGRXaYd6vRDw3WKbqixlsZReW8Ax8r5EypOHlCzyrpQEJmY43d7Qk1whebmRjeVhRVp9SbyB6bHuthSikTfevgBtYCdg1Rmmo8j9qvdUljD9hYJMppEuWh7')" }}></div>
                        <button className="absolute bottom-4 right-4 bg-primary text-black p-2 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                            <span className="material-symbols-outlined">add_shopping_cart</span>
                        </button>
                    </div>
                ...
                <div className="group bg-surface-dark rounded-xl border border-border-dark hover:border-primary/50 transition-all duration-300 overflow-hidden flex flex-col h-full">
                    <div className="relative aspect-[4/5] overflow-hidden bg-white/5">
                        ...
                        <div className="w-full h-full bg-center bg-cover transition-transform duration-500 group-hover:scale-110" data-alt="High visibility reflective safety vest" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuB5np85BL7NbPpsI80Ye4EizDunz0--nuS_q2EUgcKnU8Di-uvBdB_pYDq57a5BLY63jkVLKeXBkT0xVmvQzC9W1PogjKANsF_cRgsSms0UzvG5KM7I0zOKujCJX9qTRBpfDEnygb1P5RK0tGyeyDV0IuCbcJcf3ClOVGhkMeFaLiNzQriT5gTdTLc22rLxXs0Vj3yDPqvT-BE9rngJ1bF4xvX9teYhsQl_ZoUU6YiJP1LkGhPaMtjmvC_kUhOAPH-mvoIxukexiVHL')" }}></div>
                        <button className="absolute bottom-4 right-4 bg-primary text-black p-2 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                            <span className="material-symbols-outlined">add_shopping_cart</span>
                        </button>
                    </div>
                ...
                <div className="group bg-surface-dark rounded-xl border border-border-dark hover:border-primary/50 transition-all duration-300 overflow-hidden flex flex-col h-full">
                    <div className="relative aspect-[4/5] overflow-hidden bg-white/5">
                        <div className="w-full h-full bg-center bg-cover transition-transform duration-500 group-hover:scale-110" data-alt="Industrial steel toe work boots" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDzZR1HomkeoIUQ6SDVWnZz5qkOt_YoNLBQh2qeNNWm3rp6tSYWruFFZSLizS9w_d4iWrNB5O8UyfG0s6K9YwsQMNfEwN3xBiMBLrGFTZ8yJ1_-aUW3yxtnEwDaRG-wU_pZc20bUFK0Xwfexktc14HM2YZIa7RfHNWEkAKDjWxItvTh1dmd_xD_vU3wgbvWu7_LVD072ZXqH3KwW6UpYXdq3IM9hob8O59zyt4T85rnrHxu4U5RAIhkuwwrU3a3KNzRQi--xs_k7UrY')" }}></div>
                        <button className="absolute bottom-4 right-4 bg-primary text-black p-2 rounded-full shadow-lg opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                            <span className="material-symbols-outlined">add_shopping_cart</span>
                        </button>
                    </div>
        ...
        <section className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                {/* Industry Card 2 */}
                <a className="group relative overflow-hidden rounded-xl aspect-video bg-surface-dark border border-border-dark hover:border-primary transition-colors" href="#">
                    <div className="absolute inset-0 bg-cover bg-center opacity-40 group-hover:opacity-20 transition-opacity" data-alt="Automated manufacturing robotic arm" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDpb_Aj3ch3m6a2Vw5068g6KNVejp_x_1XdkxMKifhL3detY6fbpgq0BL7MRIOU9HykkYhOUnS7JuQDYX0AGoLG2V9hERIpX3zskguL-fsqe4evqVrWw6VHf1GYr29Vly61S3wvXbm5fcHSjrlAx3RyuJBlt8YSX59jgQWqPGcxtCnr39NSnLacv_IlkgZF91f2M_I6gKFKSRQbJ2kp5eARtVwxBDQc0hLRDE4zIQnLy_w_BjUebwTAMsBTWTtUmkKZhrYdOJuhAYZ6')" }}></div>
                    <div className="relative z-10 flex flex-col items-center justify-center h-full p-6 text-center">
                        <div className="w-16 h-16 rounded-full bg-background-dark/80 border border-border-dark flex items-center justify-center mb-4 group-hover:scale-110 group-hover:border-primary transition-all">
                ...
                {/* Industry Card 3 */}
                <a className="group relative overflow-hidden rounded-xl aspect-video bg-surface-dark border border-border-dark hover:border-primary transition-colors" href="#">
                    <div className="absolute inset-0 bg-cover bg-center opacity-40 group-hover:opacity-20 transition-opacity" data-alt="Underground mining tunnel dark" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAyPE-Y3ndkJ4T3S9YJWEsP57TnjOfbm4jltmehMKLfhmipBTsTfwjttyx3ZNw7dukOTWByODsZORVIEkliqw75X6gVJR7RLBkR4djOFyGPtnFzqkG00gVG-25-gp4Fx3u4AO6TCBoxASXuvCoPI-rNlE4w1O4L4bFoSMD7ck_Q7PKCYhJe7tsF3ovn9jxaYk7pLDnof6GXwbIGrd1sMBPDYrbbGRi7YzVCVx3F_6lXHUGAkDReX1ukmBXGuWdY-EbfKKQJsffv03PM')" }}></div>
                    <div className="relative z-10 flex flex-col items-center justify-center h-full p-6 text-center">
                        <div className="w-16 h-16 rounded-full bg-background-dark/80 border border-border-dark flex items-center justify-center mb-4 group-hover:scale-110 group-hover:border-primary transition-all">
